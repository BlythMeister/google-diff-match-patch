...
void Main()
{
	...
	Console.WriteLine();
	Console.WriteLine("* [diffs.ToHtml()](src/google-diff-match-patch-tests/OutputTests.CorrectDiffHtmlOutput_TextInput.approved.html)");
	Console.WriteLine("* [diffs.ToHtmlDocument()](src/google-diff-match-patch-tests/OutputTests.CorrectDiffHtmlDocOutput_TextInput.approved.html)");
	...
	Console.WriteLine("* [patches.ToHtml()](src/google-diff-match-patch-tests/OutputTests.CorrectPatchHtmlOutput_TextInput.approved.html)");
	Console.WriteLine("* [patches.ToHtmlDocument()](src/google-diff-match-patch-tests/OutputTests.CorrectPatchHtmlDocOutput_TextInput.approved.html)");
	...
	Console.WriteLine();
	Console.WriteLine("Usage generated by [script](src/GenerateUsages.linq)");
}
